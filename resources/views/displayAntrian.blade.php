...
<head>
    ...
    <title>Display Antrian - RS Jatiwinangun</title>

    {{-- css --}}
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
    <script src="https://code.responsivevoice.org/responsivevoice.js?key=oTCHwS3S"></script>
...
<body>
    ...
    <div class="container-xxl">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="card">
                        <div class="card-header d-block d-md-flex">
                            <h5 class="ml-5 my-auto">Display Antrian - RS Jatiwinangun</h5>
                            <button type="button" class="ml-auto mb-0 mr-5 btn btn-danger btn-icon-text text-black" id="clock" disabled></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-7 grid-margin stretch-card">
                    <div class="card shadow p-3 mb-5 bg-body rounded">
                        <div class="card-body performane-indicator-card d-flex flex-column">
                            <div class="wrapper d-flex flex-column justify-content-center absolute absolute-center">
                                <iframe style="width: 100%; height:480px" id="youtubeVideo" src="https://www.youtube.com/embed/videoseries?list=PLYkmu7SbYavwHXB7KqZhTpfC07OWWMjE8&autoplay=1&loop=1" title="Sahabat BPJS Kesehatan, sudah tahu Aplikasi Mobile JKN? begini tutorialnya" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow p-3 mb-5 bg-body rounded">
                        <div class="card-body performane-indicator-card d-flex flex-column">
                            <div class="d-sm-flex mb-3">
                                <h2 class="card-title flex-grow-1">Nomor Antrian</h2>
                            </div>
                            <div class="d-flex align-items-center justify-content-center bg-success px-4 py-8" style="height:90%;">
                                <div class="inner-card-icon">
                                    <span id="displayNumber" class="display-1 font-weight-bold text-light">-</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center shadow mt-5 bg-body rounded px-4 py-8" style="height:10%;">
                                <div class="inner-card-icon">
                                    <h2 class="card-title flex-grow-1">Menuju Loket Pendaftaran</h2>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="footer mt-5">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <marquee behavior="left" direction="left" class="text-danger">SELAMAT DATANG DI RS JATIWINANGUN PURWOKERTO - SEMOGA LEKAS SEMBUH</marquee>
            </div>
        </footer>
    </div>
    <!-- container-scroller -->
    ...
    <script>
        $(document).ready(function() {
            var bell = new Audio("{{ asset('asset/audio/tingtung.mp3') }}");

            // Function to play the bell sound
            function playBell(nomorAntrian) {
                bell.play();

                // Set delay between the bell sound and speaking the queue number
                var durasi_bell = bell.duration * 770;

                // Speak the queue number after a delay
                setTimeout(function () {
                    responsiveVoice.speak("Nomor antrian, " + nomorAntrian + ", menuju loket, Pendaftaran", "Indonesian Female", {
                        rate: 0.9,
                        pitch: 1,
                        volume: 1
                    });
            ...
            var pusher = new Pusher('c0611fe40f130132bc98', {
                cluster: 'ap1'
            });

            var channel = pusher.subscribe('channel-antrian');

            channel.bind('antrian-updated', function(data) {
                // console.log('Received antrian-updated event:', data);
                var nomorAntrian = data.noAntrian;

                // Display the queue number
                $('#displayNumber').text(nomorAntrian);

                playBell(nomorAntrian);
            });
            ...
            // Pertama kali, panggil fungsi updateClock untuk menampilkan waktu awal
            updateClock();
        });
    </script>
</body>
